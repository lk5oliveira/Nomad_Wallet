    ...
    <div class="" id="main-container">
        ...
        <!--row 1-->
            ...
            <div id="add-transaction">
                ...
                <div class="transfer-buttons-container" id="Expense" onclick="displayForm('expense')">
                    <i class="fa-solid fa-minus expense-icon icon"></i>    
                    <span class="expense-text">Add expense</span>
                </div>
                <div class="transfer-buttons-container" id="transfer" onclick="location.href='transfer.php'">
